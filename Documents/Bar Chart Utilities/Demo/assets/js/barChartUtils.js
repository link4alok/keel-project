...
// define(['jquery', 'd3'], function ($, d3) {
    ...
    var barChartUtils = (function(){
        ...
        function _draw (DOMNode) {
            ...
            margin = {top: 40, right: 100, bottom: 30, left: 70};
            width = 70;
        ...
        function _addRow(order) {
            ...
            .attr('x', -16-3*('' + addId + '').length)
            .attr('y', 2+33*(count-0.5))
            .style('font-size', '12px')
            .text(addId);

            newOrder.append('text')
            .attr('x', width + 8 - ('' + addTotal+'').length +'%')
            .attr('y', 2+33*(count-0.5))
            .style('font-size', '12px')
            ...
            $('svg').attr('height', 42+(33*count));

            if(count<3) {
                $('svg').attr('height', 42+33*3);
            }
        }
